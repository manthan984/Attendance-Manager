...
CREATE TABLE "Subject" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "dangerThreshold" DOUBLE PRECISION NOT NULL DEFAULT 75.0,
    "color" TEXT NOT NULL DEFAULT '#8D59C6',
    "userId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "AttendanceRecord" (
    ...
    "totalClasses" INTEGER NOT NULL DEFAULT 1,
...
-- CreateIndex
CREATE UNIQUE INDEX "AttendanceRecord_subjectId_date_key" ON "AttendanceRecord"("subjectId", "date");
